...
- Automated creation of the outbound VPN client
- Forced encapsulation for host and VPN traffic
...
The routing control and outbound VPN config is supported on the following platforms:
